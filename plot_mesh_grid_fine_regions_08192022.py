...
def plot_3d_mesh(z,ModelName,m,config2,best_model_, connections):
    ...
    plt.title(ttl)
    plt.savefig(os.path.join(r'C:\Users\_Kamat_\Desktop\RPI\ResearchWork\Papers_\Effective_Connectivity\EEG_fNIRS_paper_Brain_informatics\fNIRS_codes_results\Results\Results_Jun20_fineRegions\SVM_Results\figures_SVM_08202022',figName))
    #plt.show()
    plt.close()